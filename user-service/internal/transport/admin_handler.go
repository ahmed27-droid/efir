...
// func (h *AdminHandler) ShowUser() {} // ShowUserResponse
// func (h *AdminHandler) EditUser() {} // UpdateUserRequest
...
// // скидываешь код хенлдера
// // и спрашгиваешь
// // вот у меня 2 http запроса и метод DeleteUser, как обеспечить всем этим событиям транзакцию
